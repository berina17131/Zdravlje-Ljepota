	   ...
	   if(file_exists('Xml/novosti.xml'))
	  {
			 ...
			 foreach($xml->children()->children() as $novost)
			   ...
			   for ($x = $broj_elemenata - 1; $x >= 0; $x--) {
				    ...
				    if($lista_Kategorija[$x] == "Lifestyle"){?>
				   
				   <div class = "row" id = "red_clanak_z">
				   <div class = "eleven" id = "clanakz">
                    <h1 id = "naslov_z"><?php echo $listaNovosti_naslov[$x];?></h1>

					<img id = "slika_z" src = "<?php echo $listaNovosti_slike[$x];?>" alt="Photo" width="400" height="200">

                    <p id = "paragraf_z" > <?php echo $listaNovosti_tekst[$x]; ?></p>	
                   </div>
                 </div>				 
			     <?php
                } 
