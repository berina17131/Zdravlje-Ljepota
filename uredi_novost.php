   ...
   <div class = "three">
	...
	<?php
	   if(file_exists('Xml/novosti.xml'))
	  {
        ...
        <form class ="novosti_form" id = "formaNovosti" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id=<?=$novost->id?>" enctype="multipart/form-data" method="post">
		<table>
				<tr>
					<td> <label> Naslov: </label></td>
					<td> <input type="text" name="naslov" id = "Naslov" value="<?php echo $novost->naziv; ?>" onchange = 'validacijaNaslov("formaNovosti", "naslov","uredi")'></td>
				</tr>
				...
				<tr>
					...
					<td> <textarea type="text" name="tekst" id = "Tekst" onchange = 'validacijaSadrzaj("formaNovosti", "tekst","uredi")'> <?php echo $novost->sadrzaj; ?></textarea><td>
				</tr>
				...
				<tr>
						    ...
						    <option value="Home" <?php if($novost->kategorija == "Home") {?> selected="selected"; <?php } ?>>Home</option>
						    <option value="Zdravlje" <?php if($novost->kategorija == "Zdravlje") {?> selected="selected"; <?php } ?>>Zdravlje</option>
						    <option value="Ljepota" <?php if($novost->kategorija == "Ljepota") {?> selected="selected"; <?php } ?>>Ljepota</option>
						    <option value="Lifestyle" <?php if($novost->kategorija == "Lifestyle") {?> selected="selected"; <?php } ?>>Lifestyle</option>
							</select>
							</td>
				</tr>
